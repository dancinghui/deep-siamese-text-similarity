...
tf.flags.DEFINE_string("vocab_filepath", "runs/1530429767/checkpoints/vocab", "Load training time vocabulary (Default: None)")
tf.flags.DEFINE_string("model", "runs/1530429767/checkpoints/model-71000", "Load trained model checkpoint (Default: None)")
